...
var GetResponse = module.exports = function GetResponse(model, paths,
                                                        isJSONGraph,
                                                        isProgressive) {
    console.log('getResponse',model,paths)
    this.model = model;
...
GetResponse.prototype._subscribe = function _subscribe(observer) {
    ...
    console.log('remainingPaths', this.currentRemainingPaths)
    ...
    console.log('GetResponse.prototype._subscribe',this,results,seed)
...
module.exports = function checkCacheAndReport(model, requestedPaths, observer,
    ...
    console.log('checkCacheAndReport', results)
...
module.exports = function getRequestCycle(getResponse, model, results, observer,
    ...
    console.log('boundRequestedMissingPaths', boundRequestedMissingPaths)
...
module.exports = function get() {
    ...
    // will onError.
    console.log('model get',arguments,GET_VALID_INPUT)
